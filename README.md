...
[![codecov](https://codecov.io/gh/tesselle/tesselle/branch/main/graph/badge.svg)](https://codecov.io/gh/tesselle/tesselle)
...
`library(tesselle)` will load the core tesselle packages:

-   [**tabula**](https://packages.tesselle.org/tabula)
